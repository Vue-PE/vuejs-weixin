    ...
    methods: {
      ...
      change(e) {
        ...
        EXIF.getData(e.target.files[0], function(){
          ...
          me.orientation = obj.Orientation
        })
       ...
       __readFiles() {
        ...
        reader.onload = function(e) {
          if(self.orientation == 6){
            self.__getImgData(e.target.result, self.orientation, function(data){
              self.__initImage(data);
            })
          }else{
      ...
      doCrop(e) {
        ...
        if(this.head) this.data["type"] = 'head';
        if(this.imgid && this.imgid!=0) this.data["img_id"] = this.imgid;
